...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
	 ...
	 * "Please enter Valid details", ex.getMessage());
	 * 
	 ...
	 * ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
	 * 
	 * CustomErrorDetails errorDetails = new CustomErrorDetails(new Date(),
	 * "Please select correct Request Type", ex.getMessage());
	 * 
